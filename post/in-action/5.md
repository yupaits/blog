...
![仪表盘页]($withBase('/images/从Ultimate-Spider全方位解析数据采集系统的基本知识/仪表盘页.png'))

![爬虫配置页]($withBase('/images/从Ultimate-Spider全方位解析数据采集系统的基本知识/爬虫配置页.png'))

整体架构如下图所示：

![整体架构]($withBase('/images/从Ultimate-Spider全方位解析数据采集系统的基本知识/整体架构.png'))
...
![Metabase采集数据可视化]($withBase('/images/从Ultimate-Spider全方位解析数据采集系统的基本知识/Metabase采集数据可视化.png'))