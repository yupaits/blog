const sidebar = {
    '/技术博客/': {
        ...
        items: [
            ...
            {
                text: 'SpringBoot和Vue单页面前后端分离项目的整合与构建',
                link: 'SpringBoot和Vue单页面前后端分离项目的整合与构建'
            },
            ...
            {text: '项目决策', link: '项目决策'},
            {
                text: '通过开启swap分区解决小内存阿里云服务器的运行瓶颈',
                link: '通过开启swap分区解决小内存阿里云服务器的运行瓶颈'
            },
            {text: '微信公众号管理平台的实现', link: '微信公众号管理平台的实现'},
            {text: '使用GitHub和Jenkins自动构建并部署静态页面', link: '使用GitHub和Jenkins自动构建并部署静态页面'},
            {
                text: '使用Gitee+Jenkins+Docker完成前后端分离项目的CI_CD',
                link: '使用Gitee+Jenkins+Docker完成前后端分离项目的CI_CD'
            },
            ...
            {
                text: '从Ultimate-Spider全方位解析数据采集系统的基本知识',
                link: '从Ultimate-Spider全方位解析数据采集系统的基本知识'
            },
    ...
    '/文章收录/': {
        base: '/文章收录/',
        items: [
            {text: '美国政府是如何没收大量比特币的', link: '美国政府是如何没收大量比特币的'},
            {text: '面包悖论：为什么便利总是胜出，以及为何SaaS并非注定失败', link: '面包悖论：为什么便利总是胜出，以及为何SaaS并非注定失败'},
            {text: '行为经济学诱饵', link: '行为经济学诱饵'},
            {text: '互联网通信的替代方案', link: '互联网通信的替代方案'},
            {text: '软件开发的第三种方式', link: '软件开发的第三种方式'},
            {text: '脑腐状态', link: '脑腐状态'},
            {text: '杀死那个写代码的人', link: '杀死那个写代码的人'},
            {text: '房贷空手道', link: '房贷空手道'},
            ...
            {
                text: '电子邮件，应该是这样写滴（n个好习惯让我们避免互相伤害）',
                link: '电子邮件，应该是这样写滴（n个好习惯让我们避免互相伤害）'
            },
            ...
            {
                text: '90后走入焦虑时代：没房没车没京户，还要梦想着财务自由',
                link: '90后走入焦虑时代：没房没车没京户，还要梦想着财务自由'
            },
            {
                text: '2019年“互联网女皇”报告重磅出炉：你想要的干货全在这里！',
                link: '2019年“互联网女皇”报告重磅出炉：你想要的干货全在这里！'
            },
            {text: '不好意思，你的辛劳并不等于酬劳', link: '不好意思，你的辛劳并不等于酬劳'},
            {text: '如何自学一个领域？这里有一份全指南', link: '如何自学一个领域？这里有一份全指南'},
            {
                text: '卓越的人和普通的人到底区别在哪？你根本想不到是它',
                link: '卓越的人和普通的人到底区别在哪？你根本想不到是它'
            },
            ...
            {
                text: '互联网黑产：那些职业羊毛党到底如何月赚几十万？',
                link: '互联网黑产：那些职业羊毛党到底如何月赚几十万？'
            },
        ]
    },
    '/软件开发/': {
