    ...
    items: [
        ...
        items: [
          ...
          { text: 'yutool-search搜索引擎组件', link: 'yutool-search搜索引擎组件' },
          {
            ...
            items: [
              ...
              { text: '[归档] native-mobile本地手机号登录插件', link: '[归档] native-mobile本地手机号登录插件' },
              { text: '[归档] sms-reply-storage短信回复内容存储插件', link: '[归档] sms-reply-storage短信回复内容存储插件' },
              { text: '[归档] sms-verify短信验证码插件', link: '[归档] sms-verify短信验证码插件' },
          ...
          {
            text: '[归档] yutool-push推送组件',
            base: '/个人项目/yutool组件式框架/[归档] yutool-push推送组件/',
            collapsed: true,
            items: [
          ...
          { text: '[归档] yutool-file-server文件服务', link: '[归档] yutool-file-server文件服务' },
          { text: '[归档] yutool-social第三方登录组件', link: '[归档] yutool-social第三方登录组件' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '[归档] yutool-address 地址', link: '[归档] yutool-address 地址' },
          { text: '[归档] yutool-auth 认证授权', link: '[归档] yutool-auth 认证授权' },
          { text: '[归档] yutool-notify 通知消息', link: '[归档] yutool-notify 通知消息' },
        ]
      },
      {
        text: 'yupan网盘',
