...
![iStoreOS网络向导](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/iStoreOS网络向导.png)

旁路由的配置如下：

![iStoreOS旁路由配置](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/iStoreOS旁路由配置.png)
...
![DHCPv6客户端配置-1](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/DHCPv6客户端-1.png)

![DHCPv6客户端配置-2](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/DHCPv6客户端-2.png)

![DHCPv6客户端配置-3](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/DHCPv6客户端-3.png)

![DHCPv6客户端配置-4](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/DHCPv6客户端-4.png)

![DHCPv6客户端配置-5](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/DHCPv6客户端-5.png)

### iStore安装软件

在iStore中可以按需安装软件，让iStoreOS的使用场景更加丰富。注意基于Docker的软件需要启用Docker服务才能正常运行。

![iStore软件](/images/生活记录/酷玩数码/mini主机/pve虚拟机/iStoreOS旁路由/iStore软件.png)
