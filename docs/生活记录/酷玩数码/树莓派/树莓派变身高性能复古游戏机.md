...
![Lakka官网](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/Lakka官网.png)

## 下载镜像

在[Lakka官方下载页面](https://www.lakka.tv/get/windows/rpi/)上可以找到树莓派各个型号对应的镜像下载链接，点击后即可下载。

![下载Lakka镜像](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/下载Lakka镜像.png)
...
![Lakka设置WiFi](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/Lakka设置WiFi.webp)


在 `Main Menu` -> `Information` -> `Network Information` 界面查看树莓派的IP信息。

![Lakka查看IP](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/Lakka查看IP.webp)

### 启用ssh和samba服务

在Lakka系统的 `Settings` -> `Services` 界面启用ssh服务和samba服务。

![启用服务](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/启用服务.webp)
...
![设置中文](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/设置中文.webp)
...
![游戏列表文件](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/游戏列表文件.png)

![游戏列表界面](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/游戏列表界面.webp)
...
![游戏截图](/images/生活记录/酷玩数码/树莓派/树莓派变身高性能复古游戏机/游戏截图.png)
> 超级马里奥-游戏截图
