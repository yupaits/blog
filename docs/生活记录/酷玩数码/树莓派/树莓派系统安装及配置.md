...
![image.png](/images/生活记录/酷玩数码/树莓派/树莓派系统安装及配置/1667223279656-e4c612ca-0369-4ef5-819d-26a56ba8b4cd.png)
...
![image.png](/images/生活记录/酷玩数码/树莓派/树莓派系统安装及配置/1667223337741-efcf2934-eb43-42f1-98a3-d01e2fb5ce88.png)
### 系统镜像烧录
插入SD卡，安装并打开Raspberry Pi Imager。`选择操作系统`选`使用自定义镜像`，`选择SD卡`选我们插入的SD卡。

![image.png](/images/生活记录/酷玩数码/树莓派/树莓派系统安装及配置/1667223779035-5984f0d9-27d5-4465-b79c-a7f41562b7e3.png)
...
![image.png](/images/生活记录/酷玩数码/树莓派/树莓派系统安装及配置/1667225724134-2b3ad0bd-80fe-4e38-adf5-80635339f908.png)
