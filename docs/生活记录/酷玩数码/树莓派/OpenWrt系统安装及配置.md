...
![固件选择](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/固件选择.png)

## 刷入固件

将内存卡插上电脑，使用 SD Card Formatter 软件对内存卡进行格式化。

![格式化内存卡](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/格式化内存卡.png)

格式化完成后，使用 balenaEtcher 软件将固件烧录到内存卡上。

![烧录镜像](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/烧录镜像.png)
...
![OpenWrt登录界面](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/OpenWrt登录界面.png)
...
![LAN口配置1](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/LAN口配置1.png)

![LAN口配置2](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/LAN口配置2.png)

![LAN口配置3](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/LAN口配置3.png)
...
![电脑手动分配IP](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/电脑手动分配IP.png)
...
![接入OpenWrt旁路由](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/接入OpenWrt旁路由.png)

通过在OpenWrt中配置并启用各种服务之后，就可以让连接上OpenWrt的设备享受服务提供的各种实用功能（如广告过滤、科学上网等）。

![连接google](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/连接google.png)
...
![OpenWrt的AdGuardHome配置](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/OpenWrt的AdGuardHome配置.png)

打开AdGuardHome的控制台地址，登录之后通过对DNS服务器和过滤器进行配置，可实现优化网络连接速度、广告过滤等功能。

![AdGuardHome界面](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/AdGuardHome界面.png)
...
![ssr服务器节点](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/ssr服务器节点.png)

![ssr客户端设置](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/ssr客户端设置.png)
...
- 安装`privoxy`插件
  ...
  ![安装privoxy](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/安装privoxy.png)

- 启用`ShadowSocksR Plus+`的`SOCKS5 代理服务端（全局）`

  进入`服务-ShadowSocksR Plus+`页面，选择`高级设置`选项卡，启用SOCKS 5代理。

  ![启用Socks5代理](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/启用Socks5代理.png)
...
- 启用HTTP/HTTPS代理服务
  ...
  ![启动privoxy服务](/images/生活记录/酷玩数码/树莓派/OpenWrt系统安装及配置/启动privoxy服务.png)
