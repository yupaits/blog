...
![image.png](./Java线程池实现原理及其业务实践/1668309432744-c508a215-fd79-4606-8729-be42e865092a.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309436152-b805d6f0-7709-4427-b8b4-13a6ca2eb196.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309439593-b7bf7abf-de62-44f4-8664-d5c0ddc7b2c4.png)

其生命周期转换如下入所示：

![image.png](./Java线程池实现原理及其业务实践/1668309432990-2da5c4b6-bdae-4fc1-b750-70e39d60d994.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309438757-9f1756d4-8146-4764-b72b-024e5b064b57.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309433804-513c715e-c9a2-46c0-9579-85a7269d8ba8.png)

图5 阻塞队列

使用不同的队列可以实现不一样的任务存取策略。在这里，我们可以再介绍下阻塞队列的成员：

![image.png](./Java线程池实现原理及其业务实践/1668309438378-6425a496-b202-4616-81c3-131d769e708e.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309434881-4d824825-7ba3-4814-9bdb-b25faeb561c5.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309450849-04b66730-ffa3-47c3-825f-d26e3fa8d754.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309440622-09bf4dd5-a17a-4524-b476-c401d87d95e1.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309439658-5471806f-5195-4e39-9e27-66b10be72b5c.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309441783-c232e801-acdc-4467-9dd5-42e759ed504b.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309441982-2f1326dc-0e33-4f8c-ba53-e9e00948ddf2.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309441899-e31f1c84-1c8e-4040-a41a-3767982f804f.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309444159-e34b402c-f16a-4e78-992c-0ce891d77720.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309442914-7a4b1c0c-3c7c-4150-8b97-48837267c4b3.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309444377-18b23263-71bb-40c7-8aaa-b6ea28f64c48.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309443488-d2427238-ca48-4726-9351-c647bab726cc.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309454334-04d4ed45-f073-4a7b-aac1-4db280f0ec7c.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309449987-01bd6cc5-93d7-4166-a2d5-932dba83de9c.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309445146-a02a8c4d-f059-4f7f-a9e5-a87398ca4825.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309449987-e9022d88-c2ba-4dc6-bf02-dfcdd564c487.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309446579-e8d48aac-c3f0-4bc7-ace7-68e86550d869.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309447621-92ecbd2f-7475-4e27-a564-dadaf85c665f.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309450115-21d15144-6481-48ea-a2b4-8772e8748beb.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309453157-e9d18247-9eab-4fff-aee9-6c4f710e51ea.png)
...
![image.png](./Java线程池实现原理及其业务实践/1668309451688-13f323c4-582c-4d88-ad26-13bb2a96aa36.png)

图23 线程池任务执行监控
##### 3.3.4.3 运行时状态实时查看
用户基于JDK原生线程池ThreadPoolExecutor提供的几个public的getter方法，可以读取到当前线程池的运行状态以及参数，如下图所示：

![image.png](./Java线程池实现原理及其业务实践/1668309451654-19a6361c-5263-4a24-be8c-5140a6c1867a.png)

图24 线程池实时运行情况

动态化线程池基于这几个接口封装了运行时状态实时查看的功能，用户基于这个功能可以了解线程池的实时状态，比如当前有多少个工作线程，执行了多少个任务，队列中等待的任务数等等。效果如下图所示：

![image.png](./Java线程池实现原理及其业务实践/1668309452068-dd1e2d97-de3f-4637-861c-c9530f13c187.png)
