...
1.  新建会话<br />![XShell新建会话.png](./阿里云服务器环境搭建/1658767399552-eb9864f5-edce-4182-bc40-cda673d87993.png)<br />![保存主机SSH密钥.png](./阿里云服务器环境搭建/1658767405448-56ff563d-b3f5-4554-8a0f-ecd543fbc3e7.png)
2.  输入用户名、密码，执行登录<br />![登录成功.png](./阿里云服务器环境搭建/1658767410895-0fd20702-c156-4d26-8458-33eac1983a1f.png)
## 操作系统
这里选用的是CentOS 7
## 环境搭建
CentOS 7 可以使用yum安装包管理器快速安装配置各种常用的软件工具。<br />![查看yum.png](./阿里云服务器环境搭建/1658767416395-b9716789-794b-4927-a7cf-2f7c026c615c.png)<br />在安装软件工具之前，先对yum进行更新。
```
$ yum update
```
### JDK
...
```
这里显示的输出信息为：<br />![检查其他版本jdk.png](./阿里云服务器环境搭建/1658767423042-274b7657-3ac6-49ac-aedb-d221b7347c0e.png)<br />检查当前java版本信息
```
$ java -version
```
...
-  重置密码<br />![重置mysql密码.png](./阿里云服务器环境搭建/1658767437051-41aef7e0-dfe5-4b9b-a95b-321efb0e716a.png)<br />![配置mysql.png](./阿里云服务器环境搭建/1658767441282-dbd202ca-3397-4487-b116-9b11f734cd4a.png)
```
