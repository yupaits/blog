...
- 写：
  ...
  ![CacheAsidePattern写数据](/images/软件开发/中间件/缓存/CacheAsidePattern写数据.webp)

- 读：
  - 从`cache`中读取数据，读取到就直接返回
  - `cache`中读取不到的话，就从`db`中读取数据返回
  - 再把数据放到`cache`中
  ![CacheAsidePattern读数据](/images/软件开发/中间件/缓存/CacheAsidePattern读数据.webp)
...
- 写（Write Through）：
  ...
  ![WriteThroughPattern](/images/软件开发/中间件/缓存/WriteThroughPattern.webp)

- 读（Read Through）：
  - 从`cache`中读取数据，读取到就直接返回
  - 读取不到的话，先从`db`加载，写入到`cache`后返回响应
  ![ReadThroughPattern](/images/软件开发/中间件/缓存/ReadThroughPattern.webp)
...
来看客户端与Redis的一次通信过程：
![image.png](/images/软件开发/中间件/缓存/1674364927062-94e79aaf-78a7-40b4-ba16-eb399e533283.png)
...
![Redis_String](/images/软件开发/中间件/缓存/Redis_String.png)
...
![Redis_List](/images/软件开发/中间件/缓存/Redis_List.png)
...
![Redis_List_command](/images/软件开发/中间件/缓存/Redis_List_command.png)
...
![Redis_Hash](/images/软件开发/中间件/缓存/Redis_Hash.png)
...
![Redis_Set](/images/软件开发/中间件/缓存/Redis_Set.png)
...
![Redis_SortedSet](/images/软件开发/中间件/缓存/Redis_SortedSet.png)
...
![Redis_Bitmap](/images/软件开发/中间件/缓存/Redis_Bitmap.png)
...
![Redis_HyperLogLog](/images/软件开发/中间件/缓存/Redis_HyperLogLog.png)
...
![Redis_GEO](/images/软件开发/中间件/缓存/Redis_GEO.png)
...
![Redis_GeoHash](/images/软件开发/中间件/缓存/Redis_GeoHash.png)
...
![Redis_persitence](/images/软件开发/中间件/缓存/Redis_persitence.png)
...
![AOF工作基本流程](/images/软件开发/中间件/缓存/AOF工作基本流程.webp)
...
![AOF记录日志过程](/images/软件开发/中间件/缓存/AOF记录日志过程.webp)
...
![AOF重写](/images/软件开发/中间件/缓存/AOF重写.webp)
...
![Redis过期字典](/images/软件开发/中间件/缓存/redis-expired-dictionary.png)
...
![Redis_pipeline_transaction](/images/软件开发/中间件/缓存/redis-pipeline-vs-transaction.png)
...
![阿里云key分析](/images/软件开发/中间件/缓存/aliyun-key-analysis.png)
...
![京东零售开源的hotkey](/images/软件开发/中间件/缓存/jd-hotkey.png)
...
![通过阿里云的Proxy Query Cache优化热点Key问题](/images/软件开发/中间件/缓存/aliyun-hotkey-proxy-query-cache.png)
...
![缓存穿透](/images/软件开发/中间件/缓存/缓存穿透.webp)
...
![加入布隆过滤器之后的缓存处理流程图](/images/软件开发/中间件/缓存/布隆过滤器缓存处理流程.webp)
...
![缓存击穿](/images/软件开发/中间件/缓存/缓存击穿.webp)
...
![缓存雪崩](/images/软件开发/中间件/缓存/缓存雪崩.webp)
