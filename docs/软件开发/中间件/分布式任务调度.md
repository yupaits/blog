...
![elasticjob功能列表](/images/软件开发/中间件/分布式任务调度/xxljob-feature-list.png)

ElasticJob-Lite的架构设计如下图所示：

![elasticjob-lite架构设计](/images/软件开发/中间件/分布式任务调度/elasticjob-lite-architecture-design.png)
...
![xxl-job功能清单](/images/软件开发/中间件/分布式任务调度/xxljob-feature-list.png)
...
![xxl-job架构设计](/images/软件开发/中间件/分布式任务调度/xxljob-architecture-design-v2.1.0.png)
...
![xxl-job任务管理](/images/软件开发/中间件/分布式任务调度/xxljob-admin-task-management.png)
