...
![mongodb-distributed-id](/images/软件开发/架构设计/分布式/分布式ID/mongodb-distributed-id.png)
...
![RFC 4122 UUID示例](/images/软件开发/架构设计/分布式/分布式ID/rfc-4122-uuid.png)
...
![Version 1 版本下生成的 UUID 的示例](/images/软件开发/架构设计/分布式/分布式ID/version1-uuid.png)
...
![UidGenerator介绍](/images/软件开发/架构设计/分布式/分布式ID/uidgenerator-introduction-official-documents.png)
...
![Leaf原理](/images/软件开发/架构设计/分布式/分布式ID/leaf-principle.png)
...
![Tinyid原理](/images/软件开发/架构设计/分布式/分布式ID/tinyid-principle.png)
...
![Tinyid架构](/images/软件开发/架构设计/分布式/分布式ID/tinyid-architecture-design.png)
...
![文库会员支付示例](/images/软件开发/架构设计/分布式/分布式ID/distributed-id-design-pay-one-card.png)
...
![优惠编码兑换奖品](/images/软件开发/架构设计/分布式/分布式ID/distributed-id-design-coupon.png)
...
![分布式链路追踪](/images/软件开发/架构设计/分布式/分布式ID/distributed-id-design-tracing.png)
...
![短网址作用](/images/软件开发/架构设计/分布式/分布式ID/distributed-id-design-short-url.png)
