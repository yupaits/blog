...
- [JEP 417:Vector（向量） API（第三次孵化）](https://openjdk.java.net/jeps/417)
- [JEP 418:Internet-Address Resolution（互联网地址解析）SPI](https://openjdk.java.net/jeps/418)
- [JEP 419:Foreign Function & Memory API（外部函数和内存 API）（第二次孵化）](https://openjdk.java.net/jeps/419)
- [JEP 420:Pattern Matching for switch（switch 模式匹配）（第二次预览）](https://openjdk.java.net/jeps/420)
...
![JEP416Benchmark](/images/软件开发/编程基础/开发语言/Java新特性/Java18新特性/JEP416Benchmark.png)
