...
**注意**：不要把记录模式和 [JDK16](./Java16新特性) 正式引入的记录类搞混了。
...
外部函数和内存 API 在 Java 17 中进行了第一轮孵化，由 [JEP 412](https://openjdk.java.net/jeps/412) 提出。Java 18 中进行了第二次孵化，由[JEP 419](https://openjdk.java.net/jeps/419) 提出。Java 19 中是第一次预览，由 [JEP 424](https://openjdk.java.net/jeps/424) 提出。

JDK 20 中是第二次预览，由 [JEP 434](https://openjdk.java.net/jeps/434) 提出，这次的改进包括：
...
![virtual-thread](/images/软件开发/编程基础/开发语言/Java新特性/Java20新特性/virtual-threads-platform-threads-kernel-threads-relationship.png)
...
Java20 的这次孵化基本没有改变向量 API ，只是进行了一些错误修复和性能增强，详见 [JEP 438](https://openjdk.java.net/jeps/438)。
