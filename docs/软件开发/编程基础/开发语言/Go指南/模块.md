...
![创建github项目](/images/软件开发/编程基础/开发语言/Go指南/模块/创建github项目.webp)

创建完成后，可以看到仓库的 URL 是`https://github.com/246859/hello`，对应的 go 模块名就是`github.com/246859/hello`。

![模块1](/images/软件开发/编程基础/开发语言/Go指南/模块/模块1.webp)
...
![模块2](/images/软件开发/编程基础/开发语言/Go指南/模块/模块2.webp)
...
![模块3](/images/软件开发/编程基础/开发语言/Go指南/模块/模块3.webp)
...
![模块4](/images/软件开发/编程基础/开发语言/Go指南/模块/模块4.webp)
...
![模块5](/images/软件开发/编程基础/开发语言/Go指南/模块/模块5.webp)

这里会出现很多搜索结果，在使用第三方依赖时，需要结合引用次数和更新时间来决定是否采用该依赖，这里直接选择第一个

![模块6](/images/软件开发/编程基础/开发语言/Go指南/模块/模块6.webp)

进入对应的页面后，可以看出这是该依赖的一个文档页面，有着非常多关于它的详细信息，后续查阅文档时也可以来这里。

![模块7](/images/软件开发/编程基础/开发语言/Go指南/模块/模块7.webp)
...
前往[go mod cmd](https://www.golangdev.cn/cmd.html#mod)了解命令的更多有关信息。
...
![模块8](/images/软件开发/编程基础/开发语言/Go指南/模块/模块8.svg)
...
| init   | 	初始化一个新的工作区          |
| sync	  | 同步工作区的模块依赖           |
| use	   | 往go.work中添加一个新模块     |
| vendor | 	将依赖按照 vendor 格式进行复制 |

前往[go work cmd](https://www.golangdev.cn/cmd.html#work)了解命令的更多有关信息
