...
![](./单元测试/1655473325089-07727941-9bc7-4bc6-b59d-ab7e3437e5be.jpeg)

当然，这是一种理想情况。大部分情况是我们已经编写了实现代码，需要对已有的代码进行测试。

我们先通过一个示例来看如何编写测试。假定我们编写了一个计算阶乘的类，它只有一个静态方法来计算阶乘：

![](./单元测试/d6aaac468082377711356ba16248d296.svg)
...
![](./单元测试/1655473325075-b3ca26fb-57b3-4ba5-8163-12f536357b91.png)

整个项目结构如下：

![](./单元测试/1655473325018-62add277-39ed-4689-b80f-a8a67528cee0.png)
...
![](./单元测试/1655473324962-c6e6e7ee-20b8-4842-9d40-fa56076b6696.png)

如果测试结果与预期不符，`assertEquals()`会抛出异常，我们就会得到一个测试失败的结果：

![](./单元测试/1655473325023-d47faa38-ee87-47a3-81cf-0b5af25a06ca.png)
...
![](./单元测试/1655473853249-a9590141-9e65-43e0-9b01-a850d702d210.png)
