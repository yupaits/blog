...
考虑到手动安装各个服务在不同操作系统下的差异，以及初始化数据非常麻烦，我们使用[Docker Desktop](https://www.docker.com/products/docker-desktop/)来运行这些基础服务，需要在build目录下编写一个docker-compose.yml文件定义我们要运行的所有服务：
```yaml
version: "3"
services:
  zookeeper:
...
![](/images/软件开发/编程基础/开发语言/Java教程/Spring%20Cloud开发/搭建项目框架/1708686020875-b3c7354c-802d-486d-afc7-d621227e6015.png)
