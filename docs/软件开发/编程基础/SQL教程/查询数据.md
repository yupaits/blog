...
![](/images/软件开发/编程基础/SQL教程/查询数据/1656605823564-751ff044-a295-43f4-ac7e-87c3c0be783b.png)

LEFT OUTER JOIN是选出左表存在的记录：

![](/images/软件开发/编程基础/SQL教程/查询数据/1656605823579-0200b003-d4a5-4ae4-b5be-e2e9ec0bcf3a.png)

RIGHT OUTER JOIN是选出右表存在的记录：

![](/images/软件开发/编程基础/SQL教程/查询数据/1656605823578-5b3f365d-504e-4a9b-aadb-f7839cd69122.png)

FULL OUTER JOIN则是选出左右表都存在的记录：

![](/images/软件开发/编程基础/SQL教程/查询数据/1656605823561-7863e31f-1cb3-4fec-8c1f-a96e84f6431c.png)
